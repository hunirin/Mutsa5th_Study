...
public class BinaryMaxHeap {
    ...
    private void siftDown(int index) {
        while (index < size) {
            ...
            // 오른쪽도 동일, 이때 왼쪽이 더 컸으면 maxIndex가 갱신,
            // 아니라면 그대로 루트 였을것. 그래서 한번만 비교해도 둘 중 더 큰 것과 비교가 됨
    ...
    public static void main(String[] args) {
        ...
        while (!maxHeap.isEmpty()) {
            System.out.println(maxHeap.remvoe());
        }
...
//        }
//
//        int[] arr = new int[]{3, 4, 0, 5, 1, 2, 8, 6, 10};
//
//        System.out.println("priority queue");
//        // min heap을 사용하는 것과 비슷한 PriorityQueue
