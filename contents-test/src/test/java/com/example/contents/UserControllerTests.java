...
public class UserControllerTests {
    ...
    // Controller가 있을때 Http 요처이 보내졌다 가정해주는 객체
    ...
    public void testCreate() throws Exception {
        // given
        // 1. userService.createUser에 전달한 UserDto 준비
        ...
        // 3. userService.createUser의 동작 가정
        when(userService.createUser(requestDto))
                .thenReturn(responseDto);

        // when
        // perform: HTTP 요청을 보낸 것을 시뮬레이션 하여 UserController에
